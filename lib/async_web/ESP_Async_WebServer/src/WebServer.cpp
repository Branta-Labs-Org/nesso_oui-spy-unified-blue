...
#if defined(ESP32) || defined(ARDUINO_ARCH_ESP32) || defined(TARGET_RP2040) || defined(TARGET_RP2350) || defined(PICO_RP2040) || defined(PICO_RP2350) || defined(LIBRETINY) || defined(HOST)
#include <WiFi.h>
