...
// ESP32 Arduino 3.x enables LWIP_CHECK_THREAD_SAFETY — always guard raw lwIP calls.
#if (defined(ESP_IDF_VERSION_MAJOR) && ESP_IDF_VERSION_MAJOR >= 5) || defined(CONFIG_LWIP_TCPIP_CORE_LOCKING)
#define ASYNC_TCP_NEEDS_CORE_GUARD 1
#else
#define ASYNC_TCP_NEEDS_CORE_GUARD 0
#endif
...
#else   // ASYNC_TCP_NEEDS_CORE_GUARD
struct tcp_core_guard {
} __attribute__((unused));
#endif  // ASYNC_TCP_NEEDS_CORE_GUARD
}  // anonymous namespace
